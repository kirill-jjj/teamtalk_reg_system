...
class FastapiRegisteredIp(Base):
    ...
    registration_timestamp: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow, nullable=False, index=True)
...
class DeeplinkToken(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, index=True, autoincrement=True) # Assuming autoincrement based on typical ID patterns
    token: Mapped[str] = mapped_column(String, unique=True, index=True, nullable=False)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow, nullable=False)
    # expires_at is set at creation time, not a default in the model directly
    expires_at: Mapped[datetime] = mapped_column(DateTime, nullable=False, index=True)
    is_used: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False, index=True)
    generated_by_admin_id: Mapped[int | None] = mapped_column(Integer, nullable=True) # Can be nullable if generated by system or admin not tracked
