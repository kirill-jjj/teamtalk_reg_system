...
TELEGRAM_DEEPLINK_REGISTRATION_ENABLED_ENV_VAR_NAME: str = "TELEGRAM_DEEPLINK_REGISTRATION_ENABLED"
TELEGRAM_PUBLIC_REGISTRATION_ENABLED_ENV_VAR_NAME: str = "TELEGRAM_PUBLIC_REGISTRATION_ENABLED"

# --- Default Fallback Values for Configuration ---
DEFAULT_TTL_SECONDS: int = 600 # For generated files from FastAPI
DEFAULT_PENDING_REG_TTL_SECONDS_VALUE: int = int(timedelta(days=7).total_seconds())
DEFAULT_REGISTERED_IP_TTL_SECONDS_VALUE: int = int(timedelta(days=30).total_seconds())
DEFAULT_DB_CLEANUP_INTERVAL_SECONDS_VALUE: int = int(timedelta(hours=1).total_seconds())
...
DEFAULT_PENDING_REGISTRATION_TTL_SECONDS: int = _get_env_var_int(
    PENDING_REG_TTL_SECONDS_ENV_VAR_NAME, DEFAULT_PENDING_REG_TTL_SECONDS_VALUE
)
DEFAULT_REGISTERED_IP_TTL_SECONDS: int = _get_env_var_int(
    REGISTERED_IP_TTL_SECONDS_ENV_VAR_NAME, DEFAULT_REGISTERED_IP_TTL_SECONDS_VALUE
)
DB_CLEANUP_INTERVAL_SECONDS: int = _get_env_var_int(
    DB_CLEANUP_INTERVAL_SECONDS_ENV_VAR_NAME, DEFAULT_DB_CLEANUP_INTERVAL_SECONDS_VALUE
)
...
# Telegram Registration Mode Settings
TELEGRAM_DEEPLINK_REGISTRATION_ENABLED: bool = _get_env_var_bool(
    TELEGRAM_DEEPLINK_REGISTRATION_ENABLED_ENV_VAR_NAME,
    DEFAULT_TELEGRAM_DEEPLINK_REGISTRATION_ENABLED_VALUE
)
TELEGRAM_PUBLIC_REGISTRATION_ENABLED: bool = _get_env_var_bool(
    TELEGRAM_PUBLIC_REGISTRATION_ENABLED_ENV_VAR_NAME,
    DEFAULT_TELEGRAM_PUBLIC_REGISTRATION_ENABLED_VALUE
)
